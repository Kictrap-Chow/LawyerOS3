...
const dictionaries: Record<Lang, Record<string, string>> = {
  en: {
    ...
    'dashboard.actionReminders': 'Action Reminders',
    'dashboard.noActionReminders': 'No action reminders.',
    ...
    'dashboard.widgetHint': 'Widget size uses fixed presets, like macOS widgets.',
    'dashboard.widget.small': 'S',
    'dashboard.widget.medium': 'M',
    'dashboard.widget.large': 'L',
  ...
  zh: {
    ...
    'reminders.add': '添加提醒',
    'reminders.note': '备注',
    'reminders.dueDate': '提醒日期',
    'reminders.noItems': '暂无提醒事项。',
    ...
    'dashboard.actionReminders': '提醒事项',
    'dashboard.noActionReminders': '暂无提醒事项。',
    'dashboard.noScheduledEvents': '暂无日程事件。',
    'dashboard.clickToViewEvents': '点击查看事件',
    'dashboard.noEventsForDay': '当天暂无事件。',
    'dashboard.widgetHint': '小组件使用固定档位（类似 macOS），调整更稳定。',
    'dashboard.widget.small': '小',
    'dashboard.widget.medium': '中',
    'dashboard.widget.large': '大',
